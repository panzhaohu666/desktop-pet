...
class PetWindow(QWidget):
    ...
    def contextMenuEvent(self, event) -> None:
        ...
        bubble_act = menu.addAction("关闭气泡")
        bubble_act.setCheckable(True)
        bubble_act.setChecked(not self._bubbles_enabled)
        bubble_act.triggered.connect(self._toggle_bubbles)
        menu.addSeparator()
